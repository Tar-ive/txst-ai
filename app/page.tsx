...
function HomeCard() {
  return (
    <Card className="w-full md:w-1/2 overflow-hidden flex flex-col">
      <CardHeader>
        <CardTitle className="text-[#d3430d] text-center md:text-left">TXST AI Academic Advisor</CardTitle>
        <CardDescription className="text-sm md:text-base">Learn about all McCoy programs, courses, and curriculum. Ask questions with an AI chatbot and get instant help.</CardDescription>
      </CardHeader>
